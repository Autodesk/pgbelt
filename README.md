...
run pgbelt commands. The tool will look for a `configs` folder wherever you run it, which
is where your configuration needs to live.
...
directory when you execute the command.**
